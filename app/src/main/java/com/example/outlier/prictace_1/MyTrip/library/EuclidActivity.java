package com.example.outlier.prictace_1.MyTrip.library;
...
import com.example.outlier.prictace_1.MyTrip.TripActivity;
import com.example.outlier.prictace_1.MyTrip.tripLibrary.TheResultActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                startActivity(new Intent(EuclidActivity.this, TheResultActivity.class));
            }
        });
