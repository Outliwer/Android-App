 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class WayGuideActivity extends Activity implements BaiduMap.OnMapClickListener,
        OnGetRoutePlanResultListener {
    //初始化标题栏
    private ImageView titleLeftImv;
    private TextView titleTv;

    String startNodeStr = "湖北省武汉市武汉大学信息学部";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_way_guide);
        ...
        endNodeStr = intent.getStringExtra("address");
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(WayGuideActivity.this);
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(WayGuideActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        }
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_ROURE_ADDR) {
            // 起终点或途经点地址有岐义，通过以下接口获取建议查询信息
            // result.getSuggestAddrInfo()
            AlertDialog.Builder builder = new AlertDialog.Builder(WayGuideActivity.this);
            builder.setTitle("提示");
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            if (result.getRouteLines().size() > 1) {
                ...
                if (!hasShownDialogue) {
                    MyTransitDlg myTransitDlg = new MyTransitDlg(WayGuideActivity.this,
