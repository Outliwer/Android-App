...
/**
 * Created by outlier on 2017/7/23.
 */
...
public class EuclidListAdapter extends ArrayAdapter<Map<String, Object>> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final com.example.outlier.prictace_1.HomePage.Hotel.model.EuclidListAdapter.ViewHolder viewHolder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.list_item, parent, false);
            viewHolder = new com.example.outlier.prictace_1.HomePage.Hotel.model.EuclidListAdapter.ViewHolder();
            ...
            viewHolder = (com.example.outlier.prictace_1.HomePage.Hotel.model.EuclidListAdapter.ViewHolder) convertView.getTag();
        }

        Picasso.with(getContext()).load((String) mData.get(position).get(KEY_AVATAR))
                .resize(StringEuclidActivity.sScreenWidth, StringEuclidActivity.sProfileImageHeight).centerCrop()
        ...
        viewHolder.mViewOverlay.setBackground(StringEuclidActivity.sOverlayShape);
